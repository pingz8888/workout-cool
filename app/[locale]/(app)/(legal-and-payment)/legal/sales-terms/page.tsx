      ...
      <div className="container mx-auto max-w-4xl px-4">
        <header className="mb-10 text-center">
          <Typography className="mb-2 text-3xl md:text-4xl" variant="h1">
            {locale === "fr" ? "Conditions Générales d'Utilisation" : "General Terms of Use"}
          </Typography>
          <p className="text-muted-foreground text-base md:text-lg">
            {locale === "fr"
              ? "Les conditions générales d'utilisation de Workout Cool."
              : "The general terms of use for Workout Cool."}
          </p>
        </header>
