export default {
  ...
  programs: {
    ...
    more_programs_coming_description: "Мы работаем над добавлением новых программ. Следите за обновлениями!",
  ...
  tools: {
    ...
    "heart-rate-zones": {
      ...
      results: {
        overview: "Обзор ваших зон пульса",
  ...
  statistics: {
    ...
    premium_statistics_description: "Разблокируйте продвинутую аналитику и персонализированные инсайты для оптимизации тренировок.",
    upgrade_now: "Обновить Сейчас",
    no_ads: "Без рекламы",
    cancel_anytime: "Отмена в любое время",
    preview_notice: "Предпросмотр",
    preview_description: "Это предпросмотр функции премиум-статистики. Обновитесь, чтобы получить доступ ко всем данным.",
